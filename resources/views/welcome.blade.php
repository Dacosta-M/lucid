					...
					<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active text-center">
								<img src="{{ asset('img/testimonial-1.jpeg ') }}" alt="" srcset="" class="fit-cover" height="120" />
							...
							<div class="carousel-item text-center">
								<img src="{{ asset('img/testimonial-2.jpeg') }}" alt="" srcset="" class="fit-cover" height="120"/>
								<h5 class="testimonal-text">
							...
							<div class="carousel-item text-center">
								<img src="{{ asset('img/testimonial-3.jpeg') }}" alt="" srcset="" class="fit-cover" height="120" />
								<h5 class="testimonal-text">
